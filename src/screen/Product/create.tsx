...
const CreateProduct = ({RouteMatch : any = null}) => {
  ...
  const location = useLocation();
    ...
    const handleSubmit = async (e: any) => {
      ...
      const formData = { id: formValues.id, name: formValues.name, description: formValues.description, priceUn: formValues.priceUn, supplier_id: formValues.supplier_id, activated: formValues.activated };
